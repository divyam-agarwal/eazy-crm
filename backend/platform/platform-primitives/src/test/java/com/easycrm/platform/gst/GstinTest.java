...
class GstinTest {
    ...
    void rejectsBadChecksum() {
        ValidationException ex = assertThrows(ValidationException.class, () -> Gstin.parse("27AAPFU0939F1ZZ"));
    ...
    void rejectsAChecksumValidGstinWithAnInvalidStatePrefix() {
        ...
        ValidationException ex = assertThrows(ValidationException.class, () -> Gstin.parse("88AAPFU0939F1ZN"));
