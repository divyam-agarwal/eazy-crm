...
public record QuotationPdfData(
    ...
    public record Seller(String businessName, String gstin, String address, String phone, String email) {}
    ...
    public record Totals(String subTotal, String cgst, String sgst, String igst, String totalTax, String grandTotal) {}
}
