...
class ActivityVisibilityTest extends IntegrationTest {
    ...
    void seed() {
        ...
        tx.executeWithoutResult(s -> {
            ...
            execBEnquiry =
                    enquiries.saveAndFlush(newEnquiry("9876522002", execBId)).getId();
    ...
    void execCannotReadAnotherExecsEnquiryTimeline() throws Exception {
        ...
        mvc.perform(get("/api/v1/activities")
                        ...
                        .param("subjectId", execBEnquiry.toString())
    ...
    private org.springframework.test.web.servlet.ResultActions logAs(String token, UUID subject) throws Exception {
        return mvc.perform(post("/api/v1/activities")
